...
const radiosScreen =
document.getElementById("radiosScreen");

const playerScreen =
document.getElementById("playerScreen");

const openRadiosBtn =
document.getElementById("openRadiosBtn");

const backHomeBtn =
document.getElementById("backHomeBtn");

const backRadiosBtn =
document.getElementById("backRadiosBtn");

const radioCards =
document.querySelectorAll(".radio-card[data-stream]");
